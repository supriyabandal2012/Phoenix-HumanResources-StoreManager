defmodule StoreManagementWeb.StoreLive.FormComponent do
  use StoreManagementWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:store_number]} type="number" label="Store ID" />
        <.input field={@form[:street_adress]} type="text" label="Street address" />
