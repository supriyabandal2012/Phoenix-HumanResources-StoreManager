defmodule StoreManagementWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoreManagementWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoreManagementWeb.Gettext, "errors", msg, opts)
    end
  end
